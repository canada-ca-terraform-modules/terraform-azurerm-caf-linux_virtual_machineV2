...
> **Note:** This module is aligned with [azurerm 4.50.0](https://registry.terraform.io/providers/hashicorp/azurerm/4.50.0/docs/resources/linux_virtual_machine) and supports all features of the `azurerm_linux_virtual_machine` resource including disk encryption, ephemeral OS disks, confidential VM settings, and hibernation capabilities.
...
| primary                        | true,false           | No       | first NIC     |
| tags                           | map of strings       | No       | n/a           |
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_boot_diagnostic_storage"></a> [boot\_diagnostic\_storage](#module\_boot\_diagnostic\_storage) | github.com/canada-ca-terraform-modules/terraform-azurerm-caf-storage_accountV2.git | v1.0.5 |
